...
CREATE TABLE rental (
    ...
    film_id character varying(100) NOT NULL,
...
CREATE INDEX idx_film_id_store_id ON rental USING btree (film_id, store_id);

CREATE UNIQUE INDEX idx_unq_rental_rental_date_film_id_store_id_customer_id ON rental USING btree (rental_date, film_id, store_id, customer_id);
